  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="card" style="width: 70%; margin: auto">
      <div class="card-body">
        ...
        <div class="container bg-light">
          <form method="post">
            <br>
            <label label for="packagename" class="form-label">Package name</label>
            <input type="text" id="packagename" class="form-control" name="packagename">
            <br>
            <label for="elective1">Subject stream</label>
            <select id="elective1" name="elective1" class="form-control">
            ...
            <button type="submit" class="btn btn-primary" name="Submit">Add new stream</button>
          </form>
          <br>
        </div>
      </div>
    ...
    <?php
        if(isset($_POST["Submit"])){
            $sql="INSERT INTO `stream`(`streamName`) VALUES ('".$_POST['streamname']."')";
            $mysqli->query($sql);
        }
    ?>
    <script
